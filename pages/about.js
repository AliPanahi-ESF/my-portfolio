...
export default function Footer() {
  return (
    <footer className="relative w-full bg-black text-white pt-28 pb-16 px-6 overflow-hidden">
      ...
      >
        <motion.h3
          className="text-3xl md:text-5xl font-bold uppercase tracking-wider mb-4 text-white"
        >
          THANK YOU
        </motion.h3>
        <motion.p
          className="text-xl md:text-3xl text-white leading-relaxed max-w-4xl mx-auto"
        >
          You could have been anywhere on the internet, yet you are here.
          <br />
          <span className="text-blue-400 font-semibold">Thanks for visiting!</span>
        </motion.p>
      </motion.div>
    </footer>
  );
